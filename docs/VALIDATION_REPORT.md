...
- Interview section has 7 entries, 6 video embeds, 1 audio entry, and 7 transcripts.
- Credits include the latest provided class role list names.
- Known public-facing internal/dev notes are removed from content.json.
...
- The privacy section advises students not to share sensitive personal, financial, medical, identifying, or confidential information with AI tools.
